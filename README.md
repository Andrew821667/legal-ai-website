# Legal AI - Профессиональный сайт для юридических AI-решений

Современный landing page для продвижения услуг по разработке AI-систем для автоматизации юридической работы.

## 🎯 О проекте

**Legal AI** — это комплекс услуг по внедрению искусственного интеллекта в юридическую практику от команды практикующих юристов-разработчиков с многолетним опытом и глубокой экспертизой в AI.
...
**Legal AI Team** — юристы, которые сами пишут код и разрабатывают AI-системы.
