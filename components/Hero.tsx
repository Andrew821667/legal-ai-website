        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-slate-200 mb-8 animate-fade-in-delay-1">
              Мы — юристы-разработчики. Создаем системы на основе искусственного интеллекта для юридической работы.<br />
              Наши решения проверяют договоры и находят риски автоматически.<br />
              Готовим документы в 10 раз быстрее человека.
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-fade-in-delay-2">
              <AnimatedStat
                value={20}
                suffix="+"
                label="лет успешной юридической практики. Огромный опыт работы в крупных компаниях. Находим оптимальные решения для сложных задач."
              />
              <AnimatedStat
                value={80}
                suffix="%+"
                label="сокращение времени на рутинные задачи. Системы помогают юристам сосредоточиться на важном. Освобождаем время для стратегической работы."
              />
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 hover:bg-white/15 hover:border-amber-400/50 hover:scale-105 transition-all duration-300">
                ...
                <div className="text-sm text-slate-300">срок окупаемости инвестиций. Решения быстро приносят экономию. Подтверждено реальными кейсами клиентов.</div>
              </div>
            </div>
