...
<div className="space-y-6 mb-8 animate-fade-in-delay-1">
              ...
              <div>
                ...
                Мы создаем системы на базе искусственного интеллекта (ИИ) для юридических процессов.<br />                </p>
                                Автоматизируем рутину. Освобождаем время для важных задач.<br />
                                <br />
                                Повышаем эффективность вашей работы на 80%+.
              ...
              <div>
                ...
                Мы — юристы-разработчики с 20+ летним опытом.<br />
                                Сочетаем юридическую и техническую экспертизу.<br />
                                Создаем ИИ-решения сами, а не консультируем о них.</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-slate-300">
                Используем YandexGPT, GigaChat и иные модели ИИ.<br />
                                Применяем RAG-системы и мультиагентные архитектуры.<br />
                                <br />
                                Технологии работают на реальную пользу вашего бизнеса.
                                Каждое решение адаптировано под юридическую специфику.</p>
              </div>
            </div>
            {/* Stats */}
