            ...
            <div className="space-y-6 mb-8 animate-fade-in-delay-1">
              ...
              <div>
                ...
                <p className="text-lg text-slate-300">
                  Мы создаем системы на базе искусственного интеллекта (ИИ) для юридических процессов. Эти системы автоматизируют рутинные задачи, освобождая время для более важных дел. В результате, ваша работа становится более эффективной, и вы видите результат уже через 2 недели.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-slate-300">
                  Мы — юристы-разработчики с более чем 20-летним опытом. Мы объединяем юридическую и техническую экспертизу, создавая ИИ-решения самостоятельно, а не просто консультируя по их использованию.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg text-slate-300">
                  Мы используем такие модели ИИ, как YandexGPT и GigaChat, а также применяем RAG-системы и умные системы с AI-помощниками. Эти технологии приносят реальную пользу вашему бизнесу, так как каждое решение адаптировано под юридическую специфику.
                </p>
              </div>
            </div>
            {/* Stats */}
