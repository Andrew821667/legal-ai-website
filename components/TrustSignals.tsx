      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            Все наши решения основаны на актуальном законодательстве и подтверждены исследованиями ведущих аналитических агентств.
            Мы постоянно мониторим изменения в правовой сфере и обновляем наши системы.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="text-slate-300 space-y-1">
              ...
              <p className="text-sm text-slate-400 mt-2">
                Мы постоянно отслеживаем изменения в законодательстве РФ, судебной практике и отраслевых стандартах.
                Наши AI-системы обучаются на актуальных данных и обновляются в режиме реального времени.
              </p>
            </div>
          </div>
        </div>
