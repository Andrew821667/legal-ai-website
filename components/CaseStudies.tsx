      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Наши реальные проекты демонстрируют измеримые результаты, которые мы достигли для различных отраслей. Каждый кейс — это история успеха, подкрепленная конкретными цифрами и фактами.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
            Давайте обсудим, как AI может трансформировать ваш юридический отдел. Мы готовы предложить решения, которые повысят эффективность и снизят затраты, позволяя вашей команде сосредоточиться на стратегически важных задачах.
          </p>
          <a
