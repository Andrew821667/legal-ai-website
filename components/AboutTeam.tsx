      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Мы — команда профессионалов, объединяющая юридическую экспертизу и передовые технологии. Наши решения в области AI/ML помогают клиентам достигать новых высот.
          </p>
        </div>
