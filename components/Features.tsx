  ...
  const features = [
    {
      ...
      description: "Опыт в юридической сфере и программировании. Глубокое понимание отраслевых нюансов."
    },
    {
      icon: Bot,
      title: "Сами пишем код",
      description: "Полный цикл разработки и внедрения AI-систем. От идеи до реализации."
    },
    {
      icon: Flag,
      title: "Российские AI",
      description: "Интеграция с YandexGPT и GigaChat. Полное соответствие политике импортозамещения."
    },
    {
      icon: TrendingUp,
      title: "80%+ экономия",
      description: "Сокращение времени на рутинные задачи в юридических отделах до 80%."
    },
    {
      icon: Zap,
      title: "ROI 4-6 месяцев",
      description: "Автоматизация процессов обеспечивает быструю окупаемость инвестиций."
    }
  ];
