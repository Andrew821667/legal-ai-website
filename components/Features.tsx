...
export default function Features() {
  ...
  const features = [
    ...
    },
    {
      icon: Flag,
      title: "Российские AI",
      description: "Интеграция с YandexGPT и GigaChat. Соответствие политике импортозамещения."
    },
    {
      icon: TrendingUp,
      title: "80%+ экономия",
      description: "Сокращение времени на рутину в юридических отделах до 80%."
    },
    {
      icon: Zap,
      title: "ROI 4-6 месяцев",
      description: "Автоматизация процессов обеспечивает быструю окупаемость."
    }
  ];
