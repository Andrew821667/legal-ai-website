  ...
  const features = [
    {
      icon: Briefcase,
      title: "20+ лет опыта",
      description: `Более двадцати лет в юриспруденции и программировании.
        Глубоко понимаем тонкости отрасли. Знаем все нюансы работы.`
    },
    {
      icon: Bot,
      title: "Сами создаем код",
      description: `Полностью контролируем разработку AI-систем.
        От идеи до внедрения. Качество на каждом этапе.`
    },
    {
      icon: Flag,
      title: "Российские AI",
      description: `Интеграция с YandexGPT и GigaChat.
        Соответствуем политике импортозамещения. Актуальные решения для бизнеса.`
    },
    {
      icon: TrendingUp,
      title: "80%+ экономия",
      description: `Сокращаем время на рутину более чем на 80%.
        Сотрудники фокусируются на важных задачах. Больше времени на стратегию.`
    },
    {
      icon: Zap,
      title: "ROI 4-6 месяцев",
      description: `Автоматизация обеспечивает быструю окупаемость.
        Возврат инвестиций за 4-6 месяцев. Проверено на практике.`
    }
  ];
