  ...
  const magnets = [
    {
      ...
      description:
        "description: "За 30 минут разберём ваши процессы и узкие места. Покажем, где можно автоматизировать работу и сэкономить время. В конце вы получите понятный план следующих шагов.",
      features: [
