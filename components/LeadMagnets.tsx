  ...
  const magnets = [
    {
      ...
      description:
        "Оцените бизнес-процессы и узнайте, как автоматизация улучшит эффективность вашей компании.",
      features: [
    ...
    },
    {
      ...
      description:
        "Скачайте PDF с ошибками в договорах, которые выявляет наша AI-система, и защитите бизнес.",
      features: [
        "Критические условия",
        "Упущенные риски",
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
              Узнайте, как AI трансформирует ваш юридический отдел, без скрытых платежей.
            </p>
