  ...
  const magnets = [
    {
      ...
      description:
        "Получите оценку бизнес-процессов и узнайте, как автоматизация повысит эффективность вашей компании.",
      features: [
    ...
    },
    {
      ...
      description:
        "Скачайте PDF с распространенными ошибками в договорах, которые выявляет наша AI-система, и защитите бизнес.",
      features: [
        "Критические условия",
        "Упущенные риски",
    ...
    },
    {
      ...
      description:
        "Отправьте договор для анализа через AI-систему и получите рекомендации по улучшению.",
      features: [
        "Выявление рисков",
        "Анализ условий",
        "Рекомендации",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Выберите удобный способ познакомиться с нашими AI-решениями и оцените их пользу для бизнеса
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
              Получите доступ к информации о том, как AI трансформирует ваш юридический отдел, без скрытых платежей.
            </p>
