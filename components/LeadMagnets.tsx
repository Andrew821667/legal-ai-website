  ...
  const magnets = [
    {
      ...
      description:
        "Получите профессиональную оценку ваших бизнес-процессов и узнайте, как автоматизация может повысить эффективность вашей компании.",
      features: [
    ...
    },
    {
      ...
      description:
        "Скачайте бесплатный PDF с наиболее распространенными ошибками в договорах, которые выявляет наша AI-система, и защитите свой бизнес.",
      features: [
        "Критические условия",
        "Упущенные риски",
    ...
    },
    {
      ...
      description:
        "Отправьте нам ваш договор для анализа через AI-систему и получите рекомендации по его улучшению.",
      features: [
        "Выявление рисков",
        "Анализ условий",
        "Рекомендации",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className={`text-center mb-16 scroll-reveal ${headerVisible ? 'visible' : ''}`}>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Выберите удобный способ познакомиться с нашими AI-решениями и оцените их пользу для вашего бизнеса
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
              Получите доступ к качественной информации о том, как AI может трансформировать ваш юридический отдел, без скрытых платежей.
            </p>
