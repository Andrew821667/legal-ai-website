  ...
  const services = [
    {
      ...
      description:
        "Быстрый анализ входящих договоров и генерация исходящих с выявлением рисков за 5-10 минут. Эффективная обработка протоколов разногласий.",
      price: "от 150 тыс. ₽",
      features: [
        "AI-анализ рисков",
        "Генерация договоров",
    ...
    },
    {
      ...
      description:
        "Тщательный анализ судебной практики, создание процессуальных документов и мониторинг арбитражных дел.",
      price: "от 200 тыс. ₽",
      features: [
        "Поиск прецедентов",
        "Генерация исков",
    ...
    },
    {
      ...
      description:
        "Автоматизация Due Diligence с анализом сотен документов за считанные часы. Оптимизация корпоративного документооборота.",
      price: "от 300 тыс. ₽",
      features: [
    ...
    },
    {
      ...
      description:
        "Глубокий анализ правоустанавливающих документов, работа с кадастром и оспаривание кадастровой стоимости.",
      price: "от 250 тыс. ₽",
      features: [
        "Кадастровый анализ",
        "Земельные споры",
    ...
    },
    {
      ...
      title: "Комплаенс",
      description:
        "Круглосуточный мониторинг законодательства, санкционный комплаенс, управление персональными данными и антикоррупционные меры.",
      price: "от 200 тыс. ₽",
      features: [
        "Мониторинг 24/7",
    ...
    },
    {
      ...
      title: "Аналитика",
      description:
        "Анализ договорного портфеля, создание риск-дашбордов для руководства и оценка KPI юридического отдела.",
      price: "от 150 тыс. ₽",
      features: [
        "Анализ портфеля",
        "Риск-дашборды",
    ...
    },
    {
      ...
      description:
        "Разработка AI-ассистента для вашей отрасли, интеграции с CRM/ERP/1C и обучение на ваших данных.",
      price: "от 300 тыс. ₽",
      features: [
        "Под вашу отрасль",
        "Интеграции",
    ...
    },
    {
      ...
      title: "Аутсорсинг + AI",
      description:
        "Гибридная модель работы: опытный юрист в сочетании с AI-инструментами для договорной работы и судебного представительства.",
    ...
    },
    {
      ...
      description:
        "AI-мониторинг налоговой практики и законодательства. Анализ изменений, прогнозирование рисков и автоматизация отчетности.",
      price: "от 200 тыс. ₽",
      features: [
